...
public class ChatAdapter extends SimpleCursorAdapter {
	...
	private void bindViewData(ViewHolder holder, String date, boolean from_me, String from, String message, int delivery_status) {
		...
		if (from_me && !PreferenceUtil.getPrefBoolean(PreferenceUtil.SETTING_SHOW_MY_HEAD, true)) {
			holder.avatar.setVisibility(View.GONE);
		}
		holder.content.setText(MyUtil.convertNormalStringToSpannableString(mContext, message, false));
