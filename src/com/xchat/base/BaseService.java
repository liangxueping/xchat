...
public abstract class BaseService extends Service {
	...
	private static final String APP_NAME = "X-Chat";
	...
	protected void notifyClient(String fromJid, String fromUserName, String message, boolean showNotification) {
		...
		boolean vibraNotify = PreferenceUtil.getPrefBoolean(PreferenceUtil.SETTING_VIBRATION, true);
		if (vibraNotify) {
	...
	private void setNotification(String fromJid, String fromUserId, String message) {
		...
		String title = author;
		String ticker;
		boolean isShow = PreferenceUtil.getPrefBoolean(PreferenceUtil.SETTING_SHOW_NEW_MESSAGE, true);
		if (isShow) {
	...
	private void setLEDNotification() {
		boolean isLEDNotify = PreferenceUtil.getPrefBoolean(PreferenceUtil.SETTING_SHOW_LED, true);
